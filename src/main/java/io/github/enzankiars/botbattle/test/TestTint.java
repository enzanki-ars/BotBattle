package io.github.enzankiars.botbattle.test;
...
public class TestTint {
    ...
    public class TestPane extends JPanel {
		 ...
		 * 
		 */
		private static final long serialVersionUID = -6199783738554456306L;
        ...
        public TestPane() {
            try {
                master = ImageIO.read(getClass().getClassLoader().getResource("body.png"));
